...
class OpenSslKeyMaterialManager {
    ...
    void setServerKeyMaterial(OpenSslEngine engine) throws SSLException {
    ...
    void setClientKeyMaterial(OpenSslEngine engine, String[] keyTypes, X500Principal[] issuer) throws SSLException {
